...
?>
		...
		<div id = "head-1">
			<a href="../index.php"><span id ="s-1">首页</span></a><a href="../kt/index.php"><span id ="s-2">长篇</span></a><a href="/index.php"><span id ="s-3">短篇</span></a><a href="../wx/index.php"><span id ="s-4">连载</span></a>
			<div id = "son">
				当前位置：首页>短篇
			</div>
			<div id = "son-1">
