...
//				});
		...
		<script type="text/javascript">var a_idx =0;jQuery(document).ready(function($) {$("body").click(function(e) {var a =new Array("芳文大法好","百合赛高","萝莉即正义","2333","文明","和谐","自由","平等","公正","法治","爱国","敬业","诚信","友善","Xianziworld","Anko赛高");
...
?>
		...
		<div id = "head-1">
			<a href="index.php"><span id ="s-1">首页</span></a><a href="kt/index.php"><span id ="s-2">长篇</span></a><a href="xq/index.php"><span id ="s-3">短篇</span></a><a href="wx/index.php"><span id ="s-4">连载</span></a>
			<div id = "son">
				当前位置：首页
			</div>
			<div id = "son-1">
			...
			<div id="son-2">
				...
				<table>
					<tr>
						<td id="td3">1</td>
						<td id="td2"><center><a href="<?php echo getArray(1,'webs',3);?>?nob=<?php echo getArray(1,"nob",3);?>"><?php echo getArray(1,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td3">2</td>
						<td id="td2"><center><a href="<?php echo getArray(2,'webs',3);?>?nob=<?php echo getArray(2,"nob",3);?>"><?php echo getArray(2,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td3">3</td>
						<td id="td2"><center><a href="<?php echo getArray(3,'webs',3);?>?nob=<?php echo getArray(3,"nob",3);?>"><?php echo getArray(3,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">4</td>
						<td id="td2"><center><a href="<?php echo getArray(4,'webs',3);?>?nob=<?php echo getArray(4,"nob",3);?>"><?php echo getArray(4,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">5</td>
						<td id="td2"><center><a href="<?php echo getArray(5,'webs',3);?>?nob=<?php echo getArray(5,"nob",3);?>"><?php echo getArray(5,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">6</td>
						<td id="td2"><center><a href="<?php echo getArray(6,'webs',3);?>?nob=<?php echo getArray(6,"nob",3);?>"><?php echo getArray(6,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">7</td>
						<td id="td2"><center><a href="<?php echo getArray(7,'webs',3);?>?nob=<?php echo getArray(7,"nob",3);?>"><?php echo getArray(7,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">8</td>
						<td id="td2"><center><a href="<?php echo getArray(8,'webs',3);?>?nob=<?php echo getArray(8,"nob",3);?>"><?php echo getArray(8,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">9</td>
						<td id="td2"><center><a href="<?php echo getArray(9,'webs',3);?>?nob=<?php echo getArray(9,"nob",3);?>"><?php echo getArray(9,"worksname",3);?></a></center></td>
					</tr>
					<tr>
						<td id="td1">10</td>
						<td id="td2"><center><a href="<?php echo getArray(10,'webs',3);?>?nob=<?php echo getArray(10,"nob",3);?>"><?php echo getArray(10,"worksname",3);?></a></center></td>
					</tr>
				</table>
			</div>
		</div>
